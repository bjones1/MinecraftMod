...
//    public static final ItemInit sandWormsItem = new ItemInit("sand_worms", CreativeTabs.tabMaterials);
 ...
 //   		4, 0.3f, false);
 //   public static final ItemFoodInit smallPlumItem = new ItemFoodInit("small_plum", CreativeTabs.tabFood,
 //   		1, 0.3f, false);
 //   public static final ItemFoodInit orangePineappleItem = new ItemFoodInit("orange_pineapple", CreativeTabs.tabFood,
 //   		2, 5.0f, false);
...
////    {
////        public RenderEntsKrope(ModelBase p_i1266_1_, float p_i1266_3_) {
